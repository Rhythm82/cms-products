...
export default function AdminPanel() {
  ...
  const fetchProducts = async () => {
    try {
      const res = await axios.get("https://my-cms-products-v3.onrender.com/api/products");
  ...
  const toggleStatus = async (id, currentStatus) => {
    try {
      ...
      await axios.put(`https://my-cms-products-v3.onrender.com/api/products/${id}`, {
        ...product,
        status: newStatus,
        updated_by: "admin",
      });
  ...
  const deleteProduct = async (id) => {
    try {
      await axios.delete(`https://my-cms-products-v3.onrender.com/api/products/${id}`, {
